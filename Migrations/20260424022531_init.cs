        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobMatchPercentage = table.Column<int>(type: "integer", nullable: true),
                    TechnicalAlignment = table.Column<int>(type: "integer", nullable: false),
                    SoftSkillsFit = table.Column<int>(type: "integer", nullable: false),
                    DomainExperience = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Analyses", x => x.Id);
                    table.CheckConstraint("CK_Analysis_Score", "\"Score\" > 0 AND \"Score\" <= 100");
                    table.ForeignKey(
